...
function setspecdetail_json(obj) {    
    ...
    divstring += "<tr><td>Size (mm): " + obj.spec.SIZE + "</td></tr>";
    divstring += "<tr><td>Color: " + obj.spec.COLOR + "</td></tr>";
    divstring += "<tr><td>Material: " + obj.spec.MATERIAL + "</td></tr>";
    divstring += "<tr><td>Suitability: " + obj.spec.SUITABILITY + "</td></tr>";
    divstring += "<tr><td>Thickness: " + obj.spec.THICKNESS + "</td></tr>";
    divstring += "<tr><td>Tiles Type: " + obj.spec.TILESTYPE + "</td></tr>";
